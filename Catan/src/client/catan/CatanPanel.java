	...
	public CatanPanel() {
		...
		testButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				discardView.setResourceAmountChangeEnabled(ResourceType.WOOD,
						true, false);
				discardView.setResourceAmountChangeEnabled(ResourceType.SHEEP,
						true, false);
				discardView.setResourceAmountChangeEnabled(ResourceType.WHEAT,
						true, false);

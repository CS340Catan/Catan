...
public class AcceptTradeOverlay extends OverlayView implements
		IAcceptTradeOverlay {
	...
	private void initialize() {
		...
		// In Exchange For... (other pictures and lines are taken care of in
	...
	public void addGetResource(ResourceType resource, int amount) {
		...
		get_combo.setFont(new Font(HEAVY_FONT, Font.PLAIN,
	...
	public void addGiveResource(ResourceType resource, int amount) {
		...
		// The Image
		Image i = ImageUtils.loadImage("images/resources/"
				+ resource.toString().toLowerCase() + ".png");
		ImageIcon ii = new ImageIcon(i.getScaledInstance(50, 50, 0));

		// The Number (and image)
		JLabel give_combo = new JLabel(Integer.toString(amount));
		give_combo.setFont(new Font(HEAVY_FONT, Font.PLAIN,
				GIVE_AND_GET_NUMERAL_TEXT_SIZE));

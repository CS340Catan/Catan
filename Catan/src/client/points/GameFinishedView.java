...
/**
 * Implementation for the game finished view, which is displayed when the game
 * is over
 */
...
public class GameFinishedView extends OverlayView implements IGameFinishedView {
	...
	public GameFinishedView() {
		...
		messageFont = messageFont.deriveFont(messageFont.getStyle(),
				MESSAGE_TEXT_SIZE);
	...
	public void setWinner(String name, boolean isLocalPlayer) {
		...
		image.setIcon(new ImageIcon(b.getScaledInstance(newWidth, IMAGE_HEIGHT,

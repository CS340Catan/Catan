...
public class PointsView extends ComponentView implements IPointsView {
	...
	public PointsView() {
		...
		fullPointImage = ImageUtils
				.loadImage("images/victory_points/full_point.png");
		emptyPointImage = ImageUtils
				.loadImage("images/victory_points/empty_point.png");
	...
	private int drawImages(Graphics2D g2, Image image, float scale, int count,
		...
		for (int i = 0; i < count; ++i) {
			...
			g2.drawImage(image, x, y, x + scaledImageWidth, y
					+ scaledImageHeight, 0, 0, image.getWidth(null),

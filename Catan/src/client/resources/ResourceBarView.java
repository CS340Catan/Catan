...
public class ResourceBarView extends PanelView implements IResourceBarView {
	...
	// ResourceBarElement.SETTLEMENT.toString();
	...
	private void loadImages() {
		...
		settlementImage = ImageUtils.loadImage(BUILDING_IMAGE_PATH
				+ "settlement.png");
		cityImage = ImageUtils.loadImage(BUILDING_IMAGE_PATH + "city.png");
		buyDevCardImage = ImageUtils
				.loadImage(BUILDING_IMAGE_PATH + "card.jpg");
		playDevCardImage = ImageUtils.loadImage(BUILDING_IMAGE_PATH
				+ "development_card.jpg");
		soldierImage = ImageUtils
				.loadImage(BUILDING_IMAGE_PATH + "soldier.jpg");
	}
	...
	private void initializeResources() {
		...
		ResourceElement brick = new ResourceElement(ResourceBarElement.BRICK,
				false);
		ResourceElement ore = new ResourceElement(ResourceBarElement.ORE, false);
		ResourceElement sheep = new ResourceElement(ResourceBarElement.SHEEP,
				false);
		ResourceElement wheat = new ResourceElement(ResourceBarElement.WHEAT,
				false);
		ResourceElement wood = new ResourceElement(ResourceBarElement.WOOD,
				false);
		...
		ResourceElement road = new ResourceElement(ResourceBarElement.ROAD,
				true);
		ResourceElement settlement = new ResourceElement(
				ResourceBarElement.SETTLEMENT, true);
		ResourceElement city = new ResourceElement(ResourceBarElement.CITY,
				true);
		ResourceElement buyDevCard = new ResourceElement(
				ResourceBarElement.BUY_CARD, true);
		...
		ResourceElement playDevCard = new ResourceElement(
				ResourceBarElement.PLAY_CARD, true);
		...
		ResourceElement soldier = new ResourceElement(
				ResourceBarElement.SOLDIERS, false);
	...
	private class ResourceElement {
		...
		public ResourceElement(ResourceBarElement type, boolean clickable,
			...
			this.setElementImage(new BufferedImage(100, 100,
					BufferedImage.TYPE_INT_ARGB));
			this.setElementCount(elementCount);
		}

		public ResourceElement(ResourceBarElement type, boolean clickable,
				boolean enabled, BufferedImage elementImage, int elementCount) {
			this.initialize();
			this.setElementType(type);
			this.setClickable(clickable);
			this.setEnabled(enabled);
		...
		private void initialize() {
			...
			_resourceElementPanel.setLayout(new BoxLayout(
					_resourceElementPanel, BoxLayout.X_AXIS));
		...
		public void setElementImage(BufferedImage elementImage) {
			...
			this._disabledImage = new RescaleOp(scaleFactors, offsetFactors,
		...
		public JComponent asJComponent() {
			...
			_elementImageButton.setActionCommand(this.getElementType()
					.toString());

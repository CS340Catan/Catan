...
/**
 * Implementation for the wait view, which is used to display wait dialogs to
 * the user
 */
...
public class WaitView extends OverlayView implements IWaitView {
	...
	private String imageLocation = "images" + File.separator + "misc"
			+ File.separator + "hourglass.png";
	...
	public WaitView() {
		...
		BufferedImage scaledImage = new BufferedImage(img.getWidth() / 2,
				img.getHeight() / 2, BufferedImage.TRANSLUCENT);

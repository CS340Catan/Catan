...
public class MaritimeTradeOverlay extends OverlayView implements
	...
	private void initImages() {
		resourceImageFolder = "images" + File.separator + "resources"
				+ File.separator;

		reloadImg = ImageUtils.loadImage("images" + File.separator + "misc"
				+ File.separator + "reload.png");
		...
		actionListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == tradeButton) {
					...
					reset();// TODO Should I leave this in? It just emptys the

...
public class PersistancePluginRegistry {
	...
	/**
	 * given a PluginDescription, make the correct folders
	 */
	...
	/**
	 * If registeredPlugins = null: Search through plugin folder for files
	 * called "description.txt" add their information to a new PluginDescription
	 * object keep searching set registeredPlugins return the list
	 */
	...
	/**
	 * URLClassloader sets plugin JAR file on its classpath uses Class.forName()
	 * to load the class uses Class.newInstance() to create the class cast the
	 * class to an IPersistance return the IPersistance
	 */

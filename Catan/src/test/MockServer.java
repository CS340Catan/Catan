...
* @pre Valid CreateGameParams
    ...
    * Player uses this to join a game
     ...
     * @pre The player may join the game because they are already in the game, Or there is space in the game to add a new player
    ...
    * Loads a saved game
     ...
     *  @post If the operation succeeds,     the game in the specified file has been loaded into the server and its state restored (including its ID).
    ...
    * Gets the current Client Model associated with this game
     ...
     * @pre If specified, the version number is included as the “version” query parameter in the request URL, and its value is a valid integer.
...
* Sets the game back to starting state
     ...
     *  @post If the operation succeeds, the game’s command history has been cleared out
     *  @post If the operation succeeds, the game’s players have NOT been cleared out
     *  @post If the operation succeeds, the body contains the game’s updated client model JSON
     */
    @Override
 ...
 */
    ...
    * Executes commands
     ...
     *  @post If the operation succeeds, the passed ­in command list has been applied to the game.
     *  @post If the operation succeeds, the body contains an updated client model
     */
    @Override
    ...
    * Creates and adds an ai to the game
     * @pre There is space in the game for another player (i.e., the game is not “full”).
     * @pre The specified “AIType” is valid (i.e., one of the values returned by the /game/listAI method).
     * @post If the operation succeeds, a new AI player of the specified type has been added to the current game.
     */
    @Override
    ...
    * Updates the log level
     * @pre The caller specifies a valid logging level. Valid values include: SEVERE, WARNING, INFO, CONFIG, FINE, FINER, FINEST
     * @ boolean returned
     */
    @Override
    ...
    * Discards a player’s cards
     ...
     * @pre Player is logged in and part of the game
     * @pre It is the player's turn
     * @pre The settlement location is open■ The settlement location is not on water
    ...
    /** 
* This effectively ends a player’s turn and makes it the next player’s turn
     * @pre Player is logged in and part of the game
     * @pre It is the player's turn
    ...
    /**
     * Moves the robber to a new palce and possibly steals someone’s resource card
     * @pre The robber is not being kept in the same location
     * @pre If a player is being robbed (i.e., victimIndex != ­1), the player being robbed has resource cards
     * @post The robber is in the new location
     * @post The player being robbed (if any) gave you one of his resource cards (randomly selected)
    ...
    /**
     * Player plays a year of plenty card, gains two of  a certain kind of resource
     * @pre Player is logged in and part of the game
     * @pre It is the player's turn
     ...
     * @pre Player is logged in and part of the game
     * @pre It is the player's turn
     * @pre Player has enough monument cards to win the game (i.e., reach 10 victory points)
     ...
     * @pre none. Is called every second to check for updated model version on the server
